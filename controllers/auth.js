...
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="font-size:30px;">Thank You!</span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="background-color:transparent;">Thank you for registering on ${SITE_NAME}, let's buy some products.</span></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td class="pad">
<div align="center" class="alignment" style="line-height:10px"><img alt="${SITE_NAME}" src="${req.protocol}://${req.get('host')}/static/be870d00-2e4f-4ec9-bd2b-93ef54b0f935.png" style="display: block; height: auto; border: 0; width: 145px; max-width: 100%;" title="${SITE_NAME}" width="145"/></div>
</td>
</tr>
</table>
...
<tr>
<td style="padding:0 10px 0 10px;"><a href="https://www.facebook.com/jr.woles" target="_blank"><img alt="Facebook" height="32" src="${req.protocol}://${req.get('host')}/static/facebook2x.png" style="display: block; height: auto; border: 0;" title="Facebook" width="32"/></a></td>
<td style="padding:0 10px 0 10px;"><a href="https://instagram.com/ichlaswardy26" target="_blank"><img alt="Instagram" height="32" src="${req.protocol}://${req.get('host')}/static/instagram2x.png" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
<p style="margin: 0; font-size: 12px; text-align: center;"><span style="">Copyright © 2022 ${SITE_NAME}, All rights reserved.<br/><br/>Where to find us: Jl Otista Raya no 141 Gedung Maribaya Lt 3</span></p>
<p style="margin: 0; font-size: 12px; text-align: center;"><span style=""><br/>Changed your mind? You can <a href="http://www.example.com" rel="noopener" style="text-decoration: underline; color: #7f96ef;" target="_blank" title="unsubscribe">unsubscribe</a> at any time.</span></p>
</div>
</div>
</td>
</tr>
...
`
      ...
      const sendMailer = await transporter.sendMail({
        from: EMAIL_SERVICE || 'support@demo.com',
        to: data.email,
        subject: `${SITE_NAME} Services: Account has been registered`,
        html: emailTemplates
      })

      if (NODE_ENV === 'development') console.log(sendMailer)
