...
Route
  ...
  ]), cacheAllProducts, getAllProductControllers)
  .get('/:id', validate([
  ...
  ]), cacheSingleProduct, getProductControllersById)
  ...
  ]), verifyToken, grantedSellerAndAdmin, removeCacheAllProduct, postProductControllers)
  ...
  ]), verifyToken, grantedSellerAndAdmin, removeCacheSingleProduct, removeCacheAllProduct, putProductControllers)
  .delete('/:id', validate([
    param('id').escape().trim().notEmpty().withMessage('Product ID can\'t be empty').bail().isNumeric().withMessage('Product ID must be numeric').bail().toInt()
  ]), verifyToken, grantedSellerAndAdmin, removeCacheSingleProduct, removeCacheAllProduct, deleteProductControllers)
